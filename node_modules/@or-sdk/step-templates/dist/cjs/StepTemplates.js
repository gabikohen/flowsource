...
exports.StepTemplates = void 0;
var base_1 = require("@or-sdk/base");
var data_hub_svc_1 = require("@or-sdk/data-hub-svc");
var utils_1 = require("./utils");
var StepTemplates = (function () {
    function StepTemplates(params) {
    ...
    StepTemplates.prototype.listStepTemplates = function (params, paginationOptions) {
    ...
    StepTemplates.prototype.getStepTemplateById = function (id, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var step;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.listStepTemplates(__assign(__assign({}, params), { query: __assign(__assign({}, params === null || params === void 0 ? void 0 : params.query), { id: id }) }))];
                    case 1:
                        step = (_a.sent()).items[0];
                        return [2, step];
                }
            });
        });
    };
    StepTemplates.prototype.download = function (stepTemplateData, flowId) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                data = (stepTemplateData === null || stepTemplateData === void 0 ? void 0 : stepTemplateData.isExternal) ?
                    { externalStep: stepTemplateData } :
                    { stepId: stepTemplateData.id };
                return [2, this.dataHubSvc.makeRequest({
                        method: 'PUT',
                        route: "step-templates/".concat(flowId),
                        data: data,
    ...
    StepTemplates.getNewStepTemplate = function (stepId) {
        return (0, utils_1.getNewStepTemplate)(stepId);
    };
    return StepTemplates;
}());
exports.StepTemplates = StepTemplates;
